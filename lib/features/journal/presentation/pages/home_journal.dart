...
class HomeJournal extends StatefulWidget {
  const HomeJournal({super.key, this.animationController});

  final AnimationController? animationController;
  @override
  _HomeJournalState createState() => _HomeJournalState();
}

class _HomeJournalState extends State<HomeJournal>
            ...
            SingleChildScrollView(
              child: GridView.builder(
                gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
                  ...
                  childAspectRatio: 1.0, // Rasio aspek item dalam grid
                ),
                itemCount: 4,
